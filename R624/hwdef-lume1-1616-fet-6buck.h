...
/* Lume1-FF-6AF Driver with ATTINY1616
    ...
    Anduril2 for 6A Buck + FET Config
...
#ifndef PWM2_PIN
#define PWM2_PIN PB2                // PB2 FET pin
...
#define LED_ON_DELAY 50  // how many ms to delay turning on the lights after enabling the channel
